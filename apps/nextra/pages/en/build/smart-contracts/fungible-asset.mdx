...
<details>
<summary><span className="font-bold">What is the Aptos Fungible Asset (FA) standard?</h3></summary>
<div className="p-8">
...
<details>
<summary><span className="font-bold">How exactly does the new FA standard differ from legacy Coins?</h3></summary>
<div className="p-8">
...
<details>
<summary><span className="font-bold">How will this migration impact me?</h3></summary>
<div className="p-8">
...
<details>
<summary><span className="font-bold">What is the migration timeline?</h3></summary>
<div className="p-8">
...
<details>
<summary><span className="font-bold">Why is the upgrade to the Fungible Asset standard necessary?</h3></summary>
<div className="p-8">
...
<details>
<summary><span className="font-bold">What are some new and unique functionalities I can build with Fungible Assets?</h3></summary>
<div className="p-8">
...
<details>
<summary><span className="font-bold">We know there is always a paired FA of a coin type. How can we query the supply and balance of this asset after the migration?</h3></summary>
<div className="p-8">
...
<details>
<summary><span className="font-bold">Before migration, I could query all the assets a user has by getting all the resources at their address using API. How do I do it after migration?</h3></summary>
<div className="p-8">
...
<details>
<summary><span className="font-bold">What if I have more questions?</h3></summary>
<div className="p-8">
